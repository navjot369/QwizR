        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 bg-yellow-400 rounded-full p-4 shadow-lg hidden md:block"
            >
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 bg-green-400 rounded-full p-4 shadow-lg hidden md:block"
            >
